...
func (k *DockerComposeDeployer) Deploy(parentCtx context.Context, out io.Writer, builds []build.Artifact, labellers []Labeller) error {
	...
	if err := cmd.Start(); err != nil {
		return errors.Wrap(err, "starting docker-compose up")
	}
	go cmd.Wait()
	return nil
}
