...
// ParseConfigFromContents reads a configuration file.
func ParseConfigFromContents(contents []byte) (util.VersionedConfig, error) {
	apiVersion := &APIVersion{}
	if err := yaml.Unmarshal(contents, apiVersion); err != nil {
	...
	cfg := factory()
	if err := cfg.Parse(contents, false); err != nil {
